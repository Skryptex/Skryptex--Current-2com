...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Skryptex " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0x0100a8c0, 0x0200a8c0, 0x0300a8c0, 0x0400a8c0, 0x0500a8c0, 0x0600a8c0, 0x0700a8c0, 0x0800a8c0,
    0x0900a8c0, 0x0a00a8c0, 0x0b00a8c0, 0x0c00a8c0, 0x0d00a8c0, 0x0e00a8c0, 0x0f00a8c0, 0x1000a8c0,
    0x1100a8c0, 0x1200a8c0, 0x1300a8c0, 0x1400a8c0, 0x1500a8c0, 0x1600a8c0, 0x1700a8c0, 0x1800a8c0,
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Skryptex is probably already running."), addrBind.ToString().c_str());
        else
